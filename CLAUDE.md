...
Portfolio personnel de **Bastien Nieto** (`bibwann.github.io`) — développeur fullstack et
intégrateur d'IA.
...
chargés. AOS, Isotope, imagesLoaded, glightbox, swiper et php-email-form **sont encore sur le disque
mais plus jamais appelés** — ne pas les réintroduire par inadvertance. Three.js r128 et OrbitControls
viennent d'un CDN.
